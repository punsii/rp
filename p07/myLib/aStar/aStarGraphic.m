function [route, opened, closed, plots] = aStarGraphic(adj_matrix, cords, startNode, endNode, oBufSize, contDraw, makeMovie, movieName)
...
%% Init Variables
if (makeMovie) 
    file = fopen(strcat("../../matFiles/videos/", movieName), 'wt');
end
% L(F, G, H, X, Y, PREV)
